...
Thank you for your interest in contributing to **SpecAI** — a Go TUI installer for AI agent environments.
...
1. **Open an issue** using the appropriate template ([Bug Report](https://github.com/KevG1t/specai/issues/new?template=bug_report.yml) or [Feature Request](https://github.com/KevG1t/specai/issues/new?template=feature_request.yml))
...
```bash
git clone https://github.com/KevG1t/specai.git
cd specai
go build -o specai .
```
...
Use [GitHub Discussions](https://github.com/KevG1t/specai/discussions) — not issues — for questions, ideas, and general conversation.
