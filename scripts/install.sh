...
# ============================================================================
# SpecAI — Install Script
# Ecosystem, Frameworks, Workflows for AI coding agents.
#
# Usage:
#   curl -sL https://raw.githubusercontent.com/KevG1t/specai/main/scripts/install.sh | bash
#
# Or download and run:
#   curl -sLO https://raw.githubusercontent.com/KevG1t/specai/main/scripts/install.sh
#   chmod +x install.sh
#   ./install.sh
# ============================================================================
...
# Examples:
#   specai_1.0.0_darwin_arm64.tar.gz
#   specai_1.0.0_linux_amd64.tar.gz
# ============================================================================
...
print_banner() {
    ...
    echo -e "${NC}"
    echo -e "  ${DIM}SpecAI — Ecosystem, Frameworks, Workflows${NC}"
    echo ""
}
