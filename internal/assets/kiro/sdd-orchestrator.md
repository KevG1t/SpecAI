...
- **`sdd-memory`**: Fast, no files created. Artifacts live in sdd-memory only. Best for solo work and quick iteration. Note: re-running a phase overwrites the previous version.
