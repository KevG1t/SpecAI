...
4. No registry found → proceed without project skills and warn the user to run `specai skill-registry refresh`.
...
- The registry persists in sdd-memory and `.atl/skill-registry.md`.
