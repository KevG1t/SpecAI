...
Artifact store: default `sdd-memory` when available.
...
Convention files under the agent's global skills directory (global) or `.agent/skills/_shared/` (workspace): `sdd-memory-convention.md`, `persistence-contract.md`, `openspec-convention.md`.
