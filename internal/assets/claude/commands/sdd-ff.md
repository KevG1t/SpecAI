...
sdd-memory NOTE:
Sub-agents handle persistence automatically. Each phase saves its artifact to sdd-memory with topic_key "sdd/$ARGUMENTS/{type}" where type is: proposal, spec, design, tasks.
