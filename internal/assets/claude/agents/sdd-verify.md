...
model: {{CLAUDE_MODEL}}
tools: Read, Grep, Glob, Bash, mcp__plugin_sdd-memory_sdd-memory__mem_search, mcp__plugin_sdd-memory_sdd-memory__mem_get_observation, mcp__plugin_sdd-memory_sdd-memory__mem_save
---
