...
// specai injects its sections via StrategyMarkdownSections markers.
...
// SystemPromptStrategy uses MarkdownSections: specai markers are injected
// into user_rules/specai.md without clobbering other user content.
