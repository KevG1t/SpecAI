...
type Manifest struct {
	...
	// CreatedByVersion is the specai version that created this backup.
...
func backupRoot() (string, error) {
	...
	return filepath.Join(home, ".specai", "backups"), nil
}
...
// of the expected backup root (~/.specai/backups/). This prevents a tampered
